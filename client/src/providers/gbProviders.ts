...
export class Providers {
  completionsProvider: gbCompletions.CompletionRepository;
    ...
    this.completionsProvider = new gbCompletions.CompletionRepository(globalState);
  }
  ...
  public handle_document_change(event: vscode.TextDocumentChangeEvent) {
    let this_completions: gbCompletions.FileCompletions = new gbCompletions.FileCompletions(
